...
当前前端已经有 BD 大厅、独立 BD 详情页、装备详情检索、职业开荒页、伤害实验室、150 层参考页和来源覆盖页。BD 大厅支持全部职业/全部用途的职业流派矩阵；BD 详情页按资料站结构展示全身装备速览、核心暗金或威能、可替换件、技能加点顺序、巅峰点击顺序、打法循环、变体和来源状态。装备库卡片可展开查看固定词缀、配装用途、数据状态、补丁来源和图标来源。
